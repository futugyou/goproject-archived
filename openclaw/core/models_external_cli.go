...
const (
	ExternalCliRiskLevelLow    = "low"
	ExternalCliRiskLevelMedium = "medium"
	ExternalCliRiskLevelHigh   = "high"
)
...
const (
	ExternalCliOutputFormatJson   = "json"
	ExternalCliOutputFormatNdjson = "ndjson"
	ExternalCliOutputFormatCsv    = "csv"
	ExternalCliOutputFormatText   = "text"
	ExternalCliOutputFormatTable  = "table"
)
...
func NormalizeOutputFormat(val string) string {
	...
	case "json", "ndjson", "csv", "table":
		return val
	default:
		return ExternalCliOutputFormatText
	}
}
